//SIMPLIFICANDO EXPRESSÃO QUE VERIFICA SE UM NÚMERO É POTÊNCIA DE BASE 2
...
programa
{
	funcao inicio()
	{
		...
		escreva("Limpa Bit Ativo Mais a Direita de ",numero,": ", resultado,"\n")
		...
		escreva("Isola o ",posicaoDoBit + 1,"º bit de ",numero,": ", resultado,"\n")
		...
		escreva("Bit selecionado no ",posicaoDoBit + 1,"º bit de ",numero,": ", bitSelecionado,"\n")
		...
		escreva("Limpa o ",posicaoDoBit + 1,"º bit de ",numero,": ", resultado,"\n")
		////////////////////////////////////////
		...
		escreva("Ativa o ",posicaoDoBit + 1,"º bit de ",numero,": ", resultado,"\n")
		////////////////////////////////////////
		...
		escreva("Alterna o ",posicaoDoBit + 1,"º bit de ",numero,": ", resultado,"\n")
		////////////////////////////////////////
		...
		escreva("Altera o ",posicaoDoBit + 1,"º bit de ",numero," para ",valorDoBit,": ", resultado,"\n")
		////////////////////////////////////////
	}
}
